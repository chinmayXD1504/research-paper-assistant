...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    users: [
      ...
      { id: '3', email: 'sanchitmhatre815@gmail.com', full_name: 'Sanchit Mhatre', created_at: '2026-09-10 06:36:49' },
      { id: '4', email: 'scholar@research.edu', full_name: 'Academic Scholar', created_at: '2026-09-10 06:24:32' }
    ]
  });
}
